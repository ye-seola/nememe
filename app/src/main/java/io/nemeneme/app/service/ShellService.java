package io.nemeneme.app.service;
...
import io.nemeneme.app.ui.activity.MainActivity;

public class ShellService extends Service {
    private static final int NOTIFICATION_ID = 1001;
    private static final String CHANNEL_ID = "ShellService";
    public static final String ACTION_STOP = "io.nemeneme.shell.STOP_SERVICE";
    ...
    private void startServer() {
        ...
        serverThread = new Thread(() -> {
            ...
            try {
                ...
                ProcessBuilder pb = new ProcessBuilder("su", "-c", String.format("/system/bin/app_process -cp %s / --nice-name=nemeneme_shell io.nemeneme.shell.Main", apkPath));
    ...
    private void createNotificationChannel() {
        ...
        channel.setDescription("Nemeneme가 백그라운드에서 실행 중입니다");
